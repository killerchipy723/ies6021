...
async function generarConstanciaPDFg(idAlumno, carreraNombre, fechaInscripcion, estadoCarrera, alumnoNombre, dni) {
    ...
    return new Promise((resolve, reject) => {
        ...
        doc.fontSize(12).font('Helvetica').text(`Institución: IES N° 6.021 - Anexo Galpón`, { align: 'center' });
        doc.moveDown(2);
...
module.exports = generarConstanciaPDFg;
